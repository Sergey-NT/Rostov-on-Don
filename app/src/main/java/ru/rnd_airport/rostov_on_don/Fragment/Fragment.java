package ru.rnd_airport.rostov_on_don.Fragment;
...
import ru.rnd_airport.rostov_on_don.Adapter.ObjectPlaneAdapter;
import ru.rnd_airport.rostov_on_don.AppController;
import ru.rnd_airport.rostov_on_don.Constants;
import ru.rnd_airport.rostov_on_don.InfoActivity;
...
public class Fragment extends android.support.v4.app.Fragment {
    ...
    private void sendDeleteQueryToDb(String... params) {
        ...
        String url = "http://www.avtovokzal.org/php/app_rostov/deleteQuery.php?token="+params[0]+"&direction="+params[1]+"&flight="+params[2]+"&time_plan="+timePlane;
    ...
    private void sendQueryToDb(String... params) {
        ...
        String url = "http://www.avtovokzal.org/php/app_rostov/query.php?token="+params[0]+"&direction="+params[1]+"&flight="+params[2]+"&plane_direction="+planeDirection+"&time_plan="+timePlane+"&time_fact="+timeFact+"&status="+status+"&language="+language;
